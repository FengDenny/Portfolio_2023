  ...
  return (
    <section id="contact">
      ...
      >
        ...
        font-normal text-color-description 
        sm:w-96"
        >
      ...
      >
        <div className="relative top-6 mx-auto  h-auto w-52 animate-float md:w-80">
          {theme ? (
        ...
        <div className="mx-auto">
          ...
          w-80 animate-fadeIn flex-col rounded-lg bg-primary-300 p-10 
          shadow-lg  shadow-primary-100   
          transition-colors duration-75 ease-in-out
          dark:bg-color-white dark:shadow-primary-pink sm:-top-6 sm:left-0
            ...
            >
              ...
              <div className="flex w-72 flex-col">
                ...
                <input
                  ...
                  className="description-text h-9 w-60 rounded-sm border-b  border-solid border-b-primary-300  
              px-1 text-lg font-normal text-primary-300 caret-primary-pink-hover
            valid:focus-visible:outline-emerald-600 invalid:focus-visible:outline-rose-500 sm:w-72 "
              ...
              <div className="mt-3 flex w-72 flex-col">
                ...
                <input
                  ...
                  className="description-text h-9 w-60 rounded-sm  border-b border-solid  
              border-b-primary-300 px-1 text-lg font-normal  text-primary-300 caret-primary-pink-hover
            valid:focus-visible:outline-emerald-600 invalid:focus-visible:outline-rose-500 sm:w-72"
                  required
                />
                {emailError && (
              ...
              <div className="mt-3 flex  w-72 flex-col">
                ...
                <textarea
                  ...
                  className="description-text h-9 w-60 rounded-sm  border-b border-solid  
              border-b-primary-300 px-1 text-lg font-normal text-primary-300 
              caret-primary-pink-hover valid:focus-visible:outline-emerald-600 invalid:focus-visible:outline-rose-500 sm:w-72"
                  required
                />
                {messageError && (
                  <span className="mt-1 text-sm text-rose-500">
              ...
              <div className="mx-auto mt-3 sm:mx-0">
                ...
                border border-solid border-primary-pink bg-primary-pink 
                text-color-description shadow-2xl"
