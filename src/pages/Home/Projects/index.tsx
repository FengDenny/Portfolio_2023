...
const tabs = [
  {
    id: 1,
    image: StanceLabLogo, // define Label
    Component: StanceLab, // assign Component
  },
  {
    id: 2,
    image: TMBLogo,
...
const index = (props: Props) => {
  ...
  `}
    ...
    >
      <h2 className="z-40 mx-auto flex w-4/6  justify-center pt-11 text-lg text-color-white underline decoration-color-description underline-offset-4 sm:justify-end sm:text-2xl">
        Projects
      </h2>
      <Tabs
        imageStyling="relative mx-auto h-80 pt-5  w-5/6 sm:w-8/12 py-5  rounded-md mt-5  z-40 flex 
        flex-col"
